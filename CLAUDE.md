...
| 10 | 坤为地 ䷁ | `hexagrams/02-kun.html` | ⏳ **下一课** |
| 11–72 | 六十四卦 | `hexagrams/03-zhun.html` 起 | 待开 |
...
最后更新：2026-06-03（完成第九课 · 乾为天 ䷀ · 六十四卦开篇：六龙逐爻详解 + 用九"群龙无首" + 史证曾国藩"功成身退·求阙"。下一课为六十四卦第二卦"坤为地"，文件 `hexagrams/02-kun.html`，史证候选可承接乾↔坤对照，写大舜或文母太姒一类"厚德载物"之典。）

> 六十四卦课注意：①hexagrams 课每爻配真实正史人物，乾用了 项羽/唐太宗/晋文公重耳/周公/姜子牙/诸葛亮，坤起勿重复；②翻页上一篇指向 `../bagua/08-dui.html`（首卦特例），第十课起上一篇正常指向同目录前一卦；③style.css 未为 `.hex-cell.current/.done` 设样式，仅 `.locked` 变灰——解锁卡片靠去掉 locked 类即可点击，本课遵"勿改样式表"约定未加高亮，如需高亮请用户明示。
